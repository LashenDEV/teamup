            ...
            <div class="row justify-content-center align-items-center">
              <div class="col-xl-11 d-flex align-items-center justify-content-between">
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        <li><a class="nav-link scrollto @if (url()->current() == route('user.dashboard')) active @endif" href="#hero">Home</a></li>
                        ...
                        <li><a class="nav-link scrollto @if (url()->current() == route('user.profile')) active @endif" href="{{ route('user.profile') }}">Profile</a></li>
                        @if (Route::has('login'))
                                @auth
