            ...
            <div class="card-body">
                <form action="{{ route('president.meeting.update', $meeting->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput1"
                               placeholder="Enter the Meeting ID" name="meeting_id" value="{{$meeting->meeting_id}}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <p><input type="date" class="form-control" id="date" name="date" value="{{$meeting->date}}"></p>
                    </div>

                    <div class="form-group">
                        <label for="time">Time</label>
                        <p><input type="time" class="form-control" id="time" name="time" value="{{$meeting->time}}"></p>
                    </div>
