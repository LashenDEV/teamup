...
@section('content')
    ...
    <div class="card">
        <div class="container-fluid">
            ...
            <form action="{{ route('profile.update') }}" method='POST' enctype="multipart/form-data">
                ...
                <div class="col-lg-12 d-flex flex-lg-row p-3 border-none">
                    <div class="col-lg-3">
                        <div class="row m-4">
                            <div>
                                <img src="{{ $user->profile_photo != null ? asset($user->profile_photo) : asset('assets/images/Icons/User/profile_pic.png') }}"
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">how
            </div>
        </div>
    </div>
    <script>
