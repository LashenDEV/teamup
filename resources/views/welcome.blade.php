                        ...
                        @if (Route::has('login'))
                            ...
                            @else
                                ...
                                @if (Route::has('register'))
                                    <li><a class="nav-link scrollto active" href="{{ route('register') }}">Register</a>
                                    </li>
                                @endif
                            @endauth
                        @endif
    ...
    <div class="hero-container">
        <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
            ...
            <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-container">
                        <div class="container">
                            ...
                            <h3 p class="animate__animated animate__fadeInUp">Welcome to the club management system.
                                Through our website you can learn about all the clubs that exist in the university. You
                                can also register for any club online</p> </h3>
                ...
                <div class="carousel-item"
                     style="background-image: url({{asset('frontend/assets/img/hero-carousel/4.jpg')}})">
                    <div class="carousel-container">
                        <div class="container">
                            <h2 class="animate__animated animate__fadeInDown">Nam libero tempore</h2>
                            <p class="animate__animated animate__fadeInUp">Neque porro quisquam est, qui dolorem ipsum
                ...
                <div class="carousel-item"
                     style="background-image: url({{asset('frontend/assets/img/hero-carousel/5.jpg')}})">
                    <div class="carousel-container">
                        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 box box-bg">
                    ...
                    <p class="description">If theater is a big priority for you in college, learn which kinds of
                        performance opportunities exist. Musical groups are easy to find in many universities as well.
                ...
                <div class="col-lg-4 box box-bg">
                    ...
                    <p class="description">A media or publication club focuses on producing a university newspaper,
                        website, or broadcast. Many student-run newspapers are real influencers, both in university and
                        in the community. Employers are pleased to see this activity on your résumé as it matches your
                        career ambitions.</p>
                    <button class="button button1">Join Now</button>
                    <button class="button button2">More</button>
                </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <img src="{{asset('frontend/assets/img/testimonial-1.jpg')}}" class="testimonial-img"
                                 alt="">
                            <h3>Saul Goodman</h3>
                            <h4>Ceo &amp; Founder</h4>
                            <p>
                                <img src="{{asset('frontend/assets/img/quote-sign-left.png')}}" class="quote-sign-left"
                                     alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <img src="{{asset('frontend/assets/img/testimonial-2.jpg')}}" class="testimonial-img"
                                 alt="">
                            <h3>Sara Wilsson</h3>
                            <h4>Designer</h4>
                            <p>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <img src="{{asset('frontend/assets/img/testimonial-3.jpg')}}" class="testimonial-img"
                                 alt="">
                            <h3>Jena Karlis</h3>
                            <h4>Store Owner</h4>
                            <p>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <img src="{{asset('frontend/assets/img/testimonial-4.jpg')}}" class="testimonial-img"
                                 alt="">
                            <h3>Matt Brandon</h3>
                            <h4>Freelancer</h4>
                            <p>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <img src="{{asset('frontend/assets/img/testimonial-5.jpg')}}" class="testimonial-img"
                                 alt="">
                            <h3>John Larson</h3>
                            <h4>Entrepreneur</h4>
                            <p>
